...
module.exports = {
  ...
  */
  ...
  networks: {
    ...
    arbitrum_testnet: {
      network_id: 421611,
      provider: () => new HDWalletProvider(mnemonic, "wss://arb-rinkeby.g.alchemy.com/v2/" + process.env.ALCHEMY_API_KEY_ARB),
      websockets: true,
      network_id: '421611',
      gas: 200000000,
      ...
      //       phrase: mnemonic
      //     },
      //     providerOrUrl: `https://arb-rinkeby.g.alchemy.com/v2/${process.env.ALCHEMY_API_KEY_ARB}`,
      //     addressIndex: 0,
      //     numberOfAddresses: 1,
      //     network_id: 421611,
      //     chainId: 421611
    ...
    arbitrum_mainnet: {
      ...
      chain_id: 42161,
      provider: function() {
        return new HDWalletProvider(mnemonic, `https://arb-mainnet.g.alchemy.com/v2/${process.env.ALCHEMY_API_KEY_ARB_PROD}`, 0, 1);
      }
    },
  },
