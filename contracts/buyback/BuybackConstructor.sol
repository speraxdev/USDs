...
contract BuybackConstructor is Governable {
    ...
    // Swap from OUSD
    ERC20Upgradeable ousd = ERC20Upgradeable(0x2A8e1E676Ec238d8A992307B495b45B3fEAa5e86);

    // Swap to OGN
    ERC20Upgradeable ogn = ERC20Upgradeable(0x8207c1FfC5B6804F6024322CcF34F29c3541Ae26);
    ...
    ERC20Upgradeable weth9 = ERC20Upgradeable(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
    ...
    constructor(
        ...
        ousd = ERC20Upgradeable(_ousd);
        ogn = ERC20Upgradeable(_ogn);
        usdt = ERC20Upgradeable(_usdt);
        weth9 = ERC20Upgradeable(_weth9);
